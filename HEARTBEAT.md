...
- Check the reminder handoff file (default: `.reminder-signal`)
...
| Job | Schedule | Action |
|-----|----------|--------|
| reminder-check | `*/15 * * * *` | Run `scripts/check-reminders.sh`; if it writes the reminder handoff file (default: `.reminder-signal`), read it, deliver reminders, update Notion, delete the file |
