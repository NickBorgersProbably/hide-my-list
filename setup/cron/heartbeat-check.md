...
- The heartbeat is also the primary guaranteed delivery path for reminders. The isolated `reminder-check` cron only writes `.reminder-signal`; heartbeat Check 1 reads and delivers stranded reminders.
