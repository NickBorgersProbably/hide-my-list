The compressed file is provided as input text, not a file on disk. Here is the fixed compressed file with the code block corrected to match the original:
