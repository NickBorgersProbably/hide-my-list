...
readonly DOC_PATH_PATTERN='^(docs/.*\.md|design/.*\.md|setup/.*\.md|setup/model-tiers\.json|README\.md|AGENTS\.md)$'
...
# OPENCLAW_PATH_PATTERN removed: OpenClaw config and cron specs deleted in Phase D
