...
|----------|-------------|---------------|
| Selection | User requests → AI suggests | Isolated `reminder-check` writes reminder handoff file; delivered by heartbeat (60 min) or main-session startup check (next user interaction) |
