...
| Level | Score Range | Emoji Count | GIF | Music | Video | Text SO | Outing | Used For |
|-------|-------------|-------------|-----|-------|-------|---------|--------|----------|
| Lightest | 0-10 | 0 | No | No | No | No | No | Initiation only |
| Low | 11-25 | 1-2 | No | No | No | No | No | Initiation + Completion |
| Medium | 26-50 | 2-4 | Maybe | Maybe | No | Maybe | No | Initiation (max) + Completion |
| High | 51-75 | 4-6 | Yes | Yes | No | Yes | Maybe | Completion only |
| Epic | 76-100 | 6+ | Yes | Yes | Yes | Yes | Yes | Completion only |
