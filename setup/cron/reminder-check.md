...
(default: .reminder-signal) for any due reminders. If the handoff file exists afterward, read
...
Delete the handoff file only after every reminder was delivered and its Notion status was updated.
If delivery fails before that point, leave the handoff file in place and do not mark the affected reminder as sent or missed.
