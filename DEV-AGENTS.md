...
- `app/graph/nodes/rejection.py` — REJECT intent node; records the declined page as `rejected` and a listed, titled alternative as `suggested` in the recent-task ledger
